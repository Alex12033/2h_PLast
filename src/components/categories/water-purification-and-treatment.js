...
function fncWaterPurification() {
  ...
  fncProductList(
    ...
    new Product(
      ...
      require('Images/img_categories/water-purification-and-treatment/2.png'),
    ...
    new Product(
      ...
      require('Images/img_categories/water-purification-and-treatment/3.png'),
    ...
    new Product(
      ...
      require('Images/img_categories/water-purification-and-treatment/5.png'),
    ...
    new Product(
      ...
      require('Images/img_categories/water-purification-and-treatment/6.png'),
    ...
    new Product(
      ...
      require('Images/img_categories/water-purification-and-treatment/7.png'),
