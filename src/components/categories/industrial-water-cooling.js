...
function fncIndustrialWaterCooling() {
  ...
  fncProductList(
    new Product(
      'Зрошувач 2H FKP',
      '../src/assets/img_categories/industrial-water-cooling/1.png',
    ...
    new Product(
      'Зрошувач 2H FСP',
      '../src/assets/img_categories/industrial-water-cooling/2.png',
    ...
    new Product(
      ...
      '../src/assets/img_categories/industrial-water-cooling/4.png',
    ...
    new Product(
      ...
      '../src/assets/img_categories/industrial-water-cooling/5.png',
    ...
    new Product(
      ...
      '../src/assets/img_categories/industrial-water-cooling/6.png',
    ...
    new Product(
      ...
      '../src/assets/img_categories/industrial-water-cooling/7.png',
